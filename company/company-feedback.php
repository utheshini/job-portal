...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['feedback'])) {
    ...
    $sql = "INSERT INTO feedback (user_id, user_type, feedback) VALUES ('$company_id', '$user_type', '$feedback')";
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="company-feedback.php"><i class="fa fa-book"></i> Feedback</a></li>
