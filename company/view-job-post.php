          ...
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              ...
              <?php 
                ...
                <span class="margin-right-10"><i class="fa fa-money text-green"></i> Salary: LKR <?php echo htmlspecialchars($row['minimumsalary']) . ' - LKR ' . htmlspecialchars($row['maximumsalary']); ?></span><br><br>
                <span class="margin-right-10"><i class="fa fa-calendar-times-o text-green"></i> Deadline: <?php echo date("d-M-Y", strtotime($row['deadline'])); ?></span>              
            </div><br>
