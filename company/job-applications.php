          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php
             $sql = "SELECT * FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost  INNER JOIN users ON users.id_user=apply_job_post.id_user WHERE apply_job_post.id_company='$_SESSION[id_company]'";
                  ...
                  if($result->num_rows > 0) {
                    ...
                    { 
                      $status = strtolower($row['status']); // Convert status to lowercase for consistent comparison
                                ...
                                if ($status == 'pending') {
                                    ...
                                    $statusClass = 'text-success'; // Use a descriptive class for selected
                                    $statusText = 'Selected';
                                }    
            ?>
            <div class="attachment-block clearfix padding-2">
                ...
                <div class="attachment-text padding-2">
                  <div class="pull-left"><i class="fa fa-calendar"></i> <?php echo $row['apply_date']; ?></div>  
