            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="active-jobs.php"><i class="fa fa-briefcase"></i>Jobs</a></li>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT job_post.*, company.companyname FROM job_post INNER JOIN company ON job_post.id_company=company.id_company ORDER BY createdat DESC";
                      ...
                      if($result->num_rows > 0) {
                        ...
                        { 
                         ...
                         // Determine the status based on deadline
                      ...
                      <tr>
                        ...
                        <td><strong class="<?php echo $statusClass; ?>"><?php echo $status; ?></strong></td>
                        <td class="no-print"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card-o"></i></a></td>
                        <td class="no-print"><a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>" onclick="return confirm('Are you sure you want to delete this job post?');"><i class="fa fa-trash"></i></a></td>
                      </tr>  
                      <?php
                        }
                      }
