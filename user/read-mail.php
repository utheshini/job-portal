...
// Determine recipient ID based on the current user type
$recipientId = $userType == 'user' ? $row['id_fromuser'] : $row['id_touser']  ;
...
<style>
    ...
    .footer a:hover {
      color: #adb5bd; /* Light grey hover color */
    }
    ...
    .footer hr {
      border-top: 1px solid #adb5bd; /* Light grey border */
    }
  </style>
  <!-- DataTables -->
                ...
                if($resultReply->num_rows > 0) {
                  ...
                  <div class="box box-primary">
                    <div class="box-body no-padding">
                      <div class="mailbox-read-info">
                        <h3>Reply Message</h3>
                        <h5>From: <?php if($rowReply['usertype'] == "user") { echo $rowUser['firstname']; } else { echo $rowCompany['companyname']; } ?>
